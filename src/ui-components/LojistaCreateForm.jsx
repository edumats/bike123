...
export default function LojistaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setRazao_social(initialValues.razao_social);
    setNome_fantasia(initialValues.nome_fantasia);
    setNome_responsavel(initialValues.nome_responsavel);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Lojista(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LojistaCreateForm")}
      {...rest}
    >
      <TextField
        label={
